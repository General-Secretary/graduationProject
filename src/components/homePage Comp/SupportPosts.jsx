...
import PostCard from './SupportPostCard';
export default function SupportPosts({ recommendedSupportPosts, role,token }) {
    console.log(role)
    ...
    return (
        <div style={{ direction: "rtl" }} className="container  mx-auto   xl:w-[95%]">
            ...
            <div className=' mx-auto text-white'>
                <div className=" flex justify-center container mx-auto items-center w-full flex-wrap ">
                    {recommendedSupportPosts.length > 0 ? (
                        recommendedSupportPosts.slice(0, 4).map((obj, index) =>


<div key={index} className=' w-full  md:w-1/2 py-4 '>
                            ...
                            //         </div>
                            //         <div className='w-[95%] xs:w-[85%] mx-auto my-7'>
                            //             <p className='text-2xl  xs:w-[95%]  mx-auto font-semibold'>برنامج {obj?.title}</p>
                        ...
                        <p>لا يوجد منشورات حاضنات مقترحه لك </p>
                    )}
                </div>
            </div>
        </div>
