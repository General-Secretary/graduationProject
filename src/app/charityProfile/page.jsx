...
export default function page() {
    ...
    const organizationType = "CharityOrganization";
        ...
        const fetchCharityData = async () => {
            try {
                ...
                const [resCharity, resCharityPosts] = await Promise.all([
                    fetch(`https://estethmarat-estethmarat794-gmailcom-estethmarats-projects.vercel.app/api/v1/charityOrganizations/${userId}`),
            ...
            <div className="overflow-auto">
                <div className={` ${vazir.className}`}>
                    ...
                    <div style={{ direction: "rtl" }} className="container p-5 mx-auto my-32 ">
                        ...
                        <CharityPostsForProfile posts={posts.posts} token={token} triggerRefresh={() => setRefresh(prev => !prev)} />
                        <Modal
                            dismissible
                            show={openModal}
