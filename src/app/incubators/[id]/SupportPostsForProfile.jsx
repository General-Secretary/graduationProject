...
// import 'react-medium-image-zoom/dist/styles.css'
// export default function SupportPostsForProfile({ role }) {
...
//                                 <div className="relative z-10 w-full h-[250px] ">
//                                     <Image
//                                         className="w-full h-full  rounded-[50px] object-cover cursor-pointer" onClick={() => { setSelectedImage("/assits/234.png"); }}
//                                         unoptimized
//                                         src="/assits/234.png"
//                                         width={700}
//                                         height={400}
...
export default function SupportPostsForProfile({ posts, role, token }) {
    console.log(posts)
    return (
        <div style={{ direction: "rtl" }} className="container  mx-auto   xl:w-[95%]">
            <div className=' mx-auto text-white'>
                <div className=" flex justify-center container mx-auto items-center w-full flex-wrap ">
                    ...
                    {posts && posts.length > 0 ? (
                        posts.map((post) => (
                            <div key={post._id} className="w-full md:w-1/2 py-4">
                                <PostCard post={post} role={role} token={token}  />
                            </div>
                        ))
                    ) : (
                        <p className="text-white text-center my-10 text-xl">
                            لا يوجد منشورات لهذه الجمعية بعد
                        </p>
                    )}
